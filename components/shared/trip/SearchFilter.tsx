...
import { Calendar as CalendarIcon, Search, SlidersHorizontal, Users } from "lucide-react";
  ...
  return (
    <Card className="p-6 shadow-2xl">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div className="flex items-end">
          <Button onClick={handleSearch} className="w-full btn-primary" disabled={!fromRegion || !toRegion}>
            <Search />
            {t("Search")}
          </Button>
        </div>
