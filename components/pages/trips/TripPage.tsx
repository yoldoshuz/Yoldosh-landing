...
export const SearchPage = () => {
    ...
    const { data, isLoading, error } = useSearchTrips(filters, hasFilters);
                            ...
                            <div className="flex gap-2">
                                <Button
                                    className={
                                        viewMode === "grid"
                                            ? "btn-primary"
                                            : "bg-transparent hover:bg-emerald-500 cursor-pointer text-black hover:text-white"
                                    }
                                    size="icon-sm"
                            ...
                            <div className="mt-8 flex justify-center gap-2">
                                {Array.from({ length: data!.data.totalPages }, (_, i) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded ${filters.page === i + 1 ? "bg-emerald-500 text-white" : "bg-gray-200"
                                            }`}
                                    >
                                        {i + 1}
                                    </button>
