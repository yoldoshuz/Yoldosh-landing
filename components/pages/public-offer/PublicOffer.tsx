...
export const PublicOffer = () => {
  ...
  return (
    <article className="container mx-auto px-3 sm:px-6 py-12 max-w-4xl text-sm leading-relaxed text-neutral-900 bg-white">
      ...
      {/* 2. ПРЕДМЕТ ДОГОВОРА */}
      <section className="section-padding section-text">
        <h2 className="section-title">{t("subject.title")}</h2>
        <p>{t("subject.1")}</p>
        <p>{t("subject.2")}</p>
        <p>{t("subject.3")}</p>
      </section>
      ...
      <section className="section-padding section-text">
        ...
        <h3 className="section-subtitle">{t("rights.executorObliges")}</h3>
        <ul className="section-subsection">
        ...
        <h3 className="section-subtitle">{t("rights.executorRights")}</h3>
        <ul className="section-subsection">
        ...
        <h3 className="section-subtitle">{t("rights.userPassengerObliges")}</h3>
        <ul className="section-subsection">
        ...
        <h3 className="section-subtitle">{t("rights.userDriverObliges")}</h3>
        <ul className="section-subsection">
        ...
        <h3 className="section-subtitle">{t("rights.userRights")}</h3>
        <ul className="section-subsection">
      ...
      <section className="section-padding section-text">
        <h2 className="section-title">{t("liability.title")}</h2>
      ...
      {/* 8. РАЗРЕШЕНИЕ СПОРОВ */}
      <section className="section-padding section-text">
        <h2 className="section-title">{t("disputes.title")}</h2>
        <p>{t("disputes.1")}</p>
        <p>{t("disputes.2")}</p>
        <p>{t("disputes.3")}</p>
        <p>{t("disputes.4")}</p>
      ...
      <section className="section-padding section-text">
        <h2 className="section-title">{t("termination.title")}</h2>
        <p>{t("termination.1")}</p>
        <p>{t("termination.2")}</p>
        <p>{t("termination.3")}</p>
        <p>{t("termination.4")}</p>
      ...
      <section className="section-padding section-text mt-10 text-end">
        <h2 className="section-title">{t("requisites.title")}</h2>
