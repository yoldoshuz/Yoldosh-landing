...
export const BlogDetail = ({ slug }: Props) => {
    ...
    if (isError || !data?.data) {
        return (
            <div className="max-w-3xl mx-auto px-4 py-24 text-center">
                ...
                <Link href={"/blog" as any} className="text-emerald-600 font-medium hover:underline flex items-center justify-center gap-1">
    ...
    return (
        <article className="max-w-3xl mx-auto px-4 py-10">
            ...
            {/* Subtitle */}
            {blog.subtitle && (
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">{blog.subtitle}</p>
            )}
