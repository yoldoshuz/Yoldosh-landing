...
export function getOrganizationJsonLd() {
  return {
    ...
    sameAs: ["https://t.me/yoldosh_uz", "https://instagram.com/yoldosh_uz"],
  };
}

export function getPageJsonLd({ locale, path, type = "WebPage", name, description }: JsonLdOptions) {
...
export function generateTripJsonLd(trip: any, locale: string) {
  return {
    "@context": "https://schema.org",
