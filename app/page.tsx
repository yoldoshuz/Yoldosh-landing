...
export const metadata: Metadata = {
  title: "Yoldosh - Совместные поездки по Узбекистану | Каршеринг между городами",
  description:
    "Найдите попутчиков для междугородних поездок по Узбекистану. Безопасный карпулинг сервис Yoldosh соединяет водителей и пассажиров для комфортных и экономичных путешествий между Ташкентом, Самаркандом, Бухарой и другими городами. Проверенные водители, прозрачные цены, 24/7 поддержка.",
  keywords: [
